...
export function CatalogPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">Каталог продукції</h1>
        <p className="mt-2 text-slate-500">
          {products.length} позицій у каталозі · без цін · замовлення через Telegram
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white py-3 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-400 transition-all"
          />
        </div>
      </div>
